...
//    @JoinTable(name = "tb_livroautor", joinColumns = @JoinColumn(name = "autor",
//    referencedColumnName = "id", nullable = false), inverseJoinColumns = @JoinColumn(name = "livrobasico", referencedColumnName = "ISBN", nullable = false))
